...
static OID: std::sync::LazyLock<crate::oid::Oid> = std::sync::LazyLock::new(|| {
...
fn nothing_else_is_read_as_a_size() {
    for nonsense in [
        ...
        &format!("FerrLabs/Blastlands/.sizes/{}.enormous", *OID),
        // A size that would not fit the counter it feeds.
        &format!("FerrLabs/Blastlands/.sizes/{}.99999999999999999999", *OID),
