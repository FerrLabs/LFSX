...
**Lightweight.** One statically linked binary on a distroless base, no database. The published
image is 4.5 MB compressed. Objects live on the filesystem addressed by digest, or in an
