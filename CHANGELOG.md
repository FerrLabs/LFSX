...
- fix(auth): sign the App JWT once instead of once per lookup (#420)
...
- perf(build): give the release profile the settings it never had (#328)
...
- fix(server): answer --version and --help instead of starting the server (#311)
